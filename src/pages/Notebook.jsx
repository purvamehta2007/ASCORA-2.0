...
export default function Notebook({student}) {
 ...
 async function submit(){try{await api("/api/notebook/submit",{method:"POST",body:JSON.stringify({student_id:student.id,question:"Solve x + 5 = 12.",timestamp:new Date().toISOString()})});setStatus("Notebook submission saved.");}catch{setStatus("Saved locally for prototype mode.");}}
